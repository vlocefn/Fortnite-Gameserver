...
DWORD WINAPI Main(LPVOID)
{
    ...
    LOG_INFO(LogInit, "Initializing Project Bala Eats My Toes Trust");
    ...
    {
        MessageBoxA(0, "Please undefine ABOVE_S20", "FutureIScool", MB_ICONERROR);
        return 0;
    }
#else
    if (Fortnite_Version > 20)
    {
        MessageBoxA(0, "Please define ABOVE_S20", "FutureIScool", MB_ICONERROR);
        return 0;
    }
#endif
